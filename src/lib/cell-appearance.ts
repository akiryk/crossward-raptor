 ...
 * would obscure that. `recommended` (Story D6: a cell that's part of a
 * two-letter slot) is checked first within preview mode, ahead of
 * `cell.letter !== null` -- it applies whether or not the cell holds a
